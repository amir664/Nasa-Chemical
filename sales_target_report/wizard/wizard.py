...
class SalesTargetWizard(models.TransientModel):
    ...
    region_ids = fields.Many2many('res.customer.region','company_id',string="Region")
    sub_region_ids = fields.Many2many('res.customer.region','company_id',string="Sub-Region")
